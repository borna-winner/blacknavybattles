...
@onready var bullet_scene = preload("res://Bullet.tscn")  # Path to your Bullet scene

var target: Node3D  # This is the target for the shooter
...
func calculate_damage() -> float:
	...
	return 25.0  # Replace with your own logic for calculating damage
